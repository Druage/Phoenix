    ...
    Rectangle {
        ...
        ListView {
            ...
            highlight: Rectangle {
                ...
                color: listView.currentItem ? "#e8433f" : "#000000FF";
                //gradient: Gradient {
                //    GradientStop {position: 0.0; color: listView.currentItem ? "#e8433f" : "#000000FF";}
                //    GradientStop {position: 1.0; color:listView.currentItem ?  "#a22f2c" : "#000000FF";}
                //}
            }
